...
## Last updated: 2026-06-09 — mirror-sync (Gap 6 closeout/cogs_parked): the D1-G12 "NOT gated here" note corrected to supersede the "two still-open items keep their deferred gates" framing — O-24a new-vs-returning split RETIRED; thin-baseline confidence + all-explained actionability gate + residual-band cutoffs BLOCKED on the COGS foundation (O-28); Gap 6 does NOT close on these — PARKED behind O-28. | prior: 2026-06-08 — D1 Gap 6 residual pass: GATE D1-G13 added (BAU baseline excludes pre-sale ramps + onboarding two-pass backfill complete before D1 ships); D1-G5 scope extended to the CPM component's S38 explained-away suppression (universal go-quiet ceiling caps all components); the discount-depth/S19 interaction items are addressed in the G12 note below (see the 2026-06-09 correction above). | prior: 2026-06-04 — D1-G12 (Gorgias NLP parser per-brand accuracy) added; discount-depth/S19 interaction gates deferred to the cross-component residual pass
...
**NOT gated here (cogs_parked closeout, O-24/O-28):** The discount-depth/S19 interaction items
that were design-deferred to O-24 are now resolved as follows — the new-vs-existing / new-vs-returning
customer split is RETIRED (O-24a: Stage 2 already owns the return-rate component, no actionable lever),
and the thin-baseline confidence handling is REFRAMED + BLOCKED on the COGS foundation (O-28). Two
further residual items are also BLOCKED on O-28: the all-explained edge-case actionability gate, and
whether the residual-band cutoffs are brand-relative. Their gates are written when O-28 unblocks them;
closing them does NOT on its own close Gap 6 — Gap 6 is PARKED behind O-28. The rest of the 2026-06-08
